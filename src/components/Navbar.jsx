    ...
    <section className="flex w-full bg-[#222831] text-[#EEEEEE] justify-between px-10 h-[75px] items-center ">
      ...
      <div className="flex items-center gap-2">
        <img
          ...
          srcset=""
        />
        <h1 className="font-extrabold text-2xl"> <span className="border-b-2 border-[#00ADB5]">React</span> Shop</h1>
      </div>
      ...
      <div className="flex flex-row items-center justify-center">
        <div className="flex relative justify-center items-center">
          {/* Search */}
            <form role={"search"} action="" className="flex rounded-sm bg-[#EEEEEE] gap-1 p-0.5">
              <input className="text-[#222831] font-bold w-32 px-1  rounded-sm" aria-label="Search" placeholder="Cari disini..." type="text" />
              <a href="/"><i class="bi bi-search px-1 text-xl bg-[#222831] rounded-sm"></i></a>
            </form>
          ...
          <a className="border-2 border-[#00ADB5] bg-[#00ADB5] text-[#222831] rounded-sm px-3" href="/">
